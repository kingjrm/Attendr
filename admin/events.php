            ...
            <div class="overflow-x-auto rounded-xl">
                ...
                <thead>
                    <tr class="bg-neutral-100 text-neutral-700">
                        <th class="py-1.5 px-3 font-semibold">Title</th>
                        <th class="py-1.5 px-3 font-semibold">Date</th>
                        <th class="py-1.5 px-3 font-semibold">Time</th>
                        <th class="py-1.5 px-3 font-semibold">Venue</th>
                        <th class="py-1.5 px-3 font-semibold">Max</th>
                        <th class="py-1.5 px-3 font-semibold">Actions</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                ...
                foreach ($filtered_events as $event): ?>
                    <tr class="border-b last:border-0 hover:bg-neutral-50 transition">
                        <td class="py-1.5 px-3"> <?php echo htmlspecialchars($event['title']); ?> </td>
                        <td class="py-1.5 px-3"> <?php echo htmlspecialchars($event['event_date']); ?> </td>
                        <td class="py-1.5 px-3"> <?php echo htmlspecialchars(substr($event['event_time'],0,5)); ?> </td>
                        <td class="py-1.5 px-3"> <?php echo htmlspecialchars($event['venue']); ?> </td>
                        <td class="py-1.5 px-3"> <?php echo (int)$event['max_participants']; ?> </td>
                        <td class="py-1.5 px-3 flex gap-2">
